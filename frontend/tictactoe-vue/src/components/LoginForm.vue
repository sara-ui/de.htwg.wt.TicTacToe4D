  ...
  <form class="needs-validation" @submit="submit">
    ...
    <div class="form-group">
      ...
      <input
        ...
        class="form-control"
        id="player2"
        aria-describedby="player2Help"
        v-model="payload.player2"
        required
      />
      <small id="player2Help" class="form-text text-muted"
        >For example: Simon</small
      >
    </div>
    <button type="submit" class="btn btn-primary btn-block btn-lg mb-5">
      Start The Game
    </button>
  </form>
</template>
